/*
 * Filename:     JQFoodItemSearchFunctions.js
 * Author:       Andrew Laing
 ...
 *               loaded search results for food item details.
 * Contents:     
 */
...
$(document).ready(function(){
    ...
    $("#searchBtn").click(function(event){
        var p_itemId = $("input[name=s_idnum].inputField").val();
        var p_itemname = $("input[name=s_itemname].inputField").val();
        var p_category = $("input[name=s_category].inputField").val();

        $.post( "ajaxhandlers/searchMenuItemRecordsHandler.php",
        {
            itemID: p_itemId, 
            itemname: p_itemname,
            category: p_category
