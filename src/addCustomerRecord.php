...
<div class="container-fluid"> 
  <div class="container">
    <form role="form" class="form-inline" method="post" name="frmAddRecord" action="customerRecordAdded.php">
      ...
      <div class="row">
        <div class="form-group col-sm-12">
          <button type="" buttonclass="btn btn-info btn-cancel" name="cancel" 
