<!--
 * Filename:     staffRecordDeleted.php
 * Author:       Andrew Laing
 * Email:        parisianconnections@gmail.com
 * Last updated: 26/06/2019.
 * Description:  This page is used to delete a staff record with
 *               the details posted from delete StaffRecord.php
-->
...
<?php 
  ...
  if($staffId==-1 || $staffId==null){
    ...
    if ($stmt = $mysqli->prepare("CALL deleteStaffDetails ((?))")) {
