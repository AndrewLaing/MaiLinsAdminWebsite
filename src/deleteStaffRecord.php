<!--
 * Filename:     deleteStaffRecord.php
 * Author:       Andrew Laing
 * Email:        parisianconnections@gmail.com
 * Last updated: 31/05/2019.
 * Description:  This page allows the user to delete a staff record. 
-->
...
<div class="container-fluid"> 
  <div class="container">
    ...
    <form role="form" class="form-inline" method="post" name="frmDetails" action="staffRecordDeleted.php">
