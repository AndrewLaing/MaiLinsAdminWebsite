<!--
 * Filename:     editStaffMemberAccessLevel.php
 * Author:       Andrew Laing
 * Email:        parisianconnections@gmail.com
 * Last updated: 28/06/2019.
 * Description:  The page allows the user to change a staff member's
...
<header class="header">
    ...
    <h1>Change Staff Website Access Level</h1>
    </div>
...
<div class="container-fluid"> 
    ...
    <div class="form-inline"> <!-- START OF SEARCH SECTION -->
        ...
        <input type="text" id="s_idnum" name="s_idnum" placeholder="Staff ID number ..." maxlength="34" 
        ...
        <label for="s_jobpos" class="control-label inputLabel">Position</label>
        <input type="text" id="s_jobpos" name="s_jobpos" placeholder="Current job position ..." maxlength="34" 
                class="form-control inputField">
        </div>
...
<!-- Edit details Form  -->
<form role="form" class="form-inline" method="post" action="accessLevelUpdated.php">    
    <div > <!-- START OF DETAILS SECTION -->
        ...
        <label for="d_accessLevel" class="control-label inputLabel" >Access Level</label>
        <input type="text" id="d_accessLevel" name="d_accessLevel" placeholder="New Access Level ..." maxlength="1" 
        ...
        <div>
            <button type="submit" class="btn btn-info btn-order" name="saveChanges" value="saveChanges"
                    onClick="return confirm_update_record();">SAVE CHANGES</button>
            <!-- A button of type button does not submit -->
            <button type="button" class="btn btn-info btn-cancel" name="cancel" 
                    value="cancel"  onClick="alert('Changes cancelled'); updateDetailsFields(dataArray, currentRecord);">CANCEL</button>    
        </div>    
