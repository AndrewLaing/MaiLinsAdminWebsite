 ...
 * Description:  The Error page will be shown when anything goes wrong with
 *               database interactions. Rather than showing an error message 
 *               disclosing database details, it will ask the user to contact 
...
<div class="container-fluid"> 
  <div class="row">
    <div class="col col-sm-12 content">
      <h1>Error</h1> 
      <br />
      <p>Oops! Something went wrong when processing your data.</p>
      <p>Please complete the form below or contact the site's administrator at <a href="mailto:admin@mailinsrestaurant.com?Subject=Website%20Error" target="_top">admin@mailinsrestaurant.com</a> and let us know as soon as possible</p>
      <br />
        <form role="form" method="post" name="frmFeedback" action="sendMessage.php">
          ...
          <label for="msg">Details about the error</label>&nbsp;(Maximum 500 chars)
